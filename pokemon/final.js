...
async function battle(player, bot) {
  ...
  if (playerHP <= 0 && botHP <= 0) console.log("😵 Match nul !");
...
async function main() {
  console.clear();
  console.log("=== Pokémon CLI Battle (PokéAPI Edition) ===\n");
  ...
  const { again } = await inquirer.prompt([
    { type: "confirm", name: "again", message: "Voulez-vous rejouer ?", default: false },
  ]);
